...
[Hacker News](https://news.ycombinator.com/)（通称 HN）は、Y Combinator が運営するソーシャルニュースサイト。テクノロジー、スタートアップ、プログラミング、科学などの話題を中心に、ユーザーが記事を投稿・投票・議論する。シリコンバレーのエンジニアや起業家が多く集まるため、テック業界のトレンドをいち早くキャッチできる場として知られている。ただし記事もコメントも全て英語のため、英語に不慣れな人にとっては敷居が高い。このプロジェクトは、その日のトップ記事を日本語で丁寧に要約することで、誰でも HN の議論にアクセスできるようにすることを目的としている。
...
難しい用語には `用語（わかりやすい解説）` の形式で文中に注釈が入る。単語自体は（）で囲まない。
